...
$stringsRoot = Join-Path $root 'src\StreamNumDeck.Wpf\Strings'
...
$strings = [ordered]@{
    ...
    Capture_NumPad = 'NumPad'
    Capture_NavigationBlock = '6-key block'
    Capture_NumPadHint = 'Intercept NumPad keys'
    Capture_NavigationBlockHint = 'Intercept the Insert, Home, Page Up, Delete, End, and Page Down keys'
    ...
    'Settings_UpdatesTitle.Text' = 'Stay up to date'
    'Settings_UpdatesHint.Text' = 'Follow StreamNumDeck on GitHub for new versions, fixes, and features.'
    'Settings_ReleasesButton.Content' = 'Latest release'
    ...
    ActionGroup_Automation = 'Automation'
    ...
    Action_ObsToggleStream = 'Streaming: On/Off'
    Action_ObsStartStream = 'Start streaming'
    Action_ObsStopStream = 'Stop streaming'
    Action_ObsToggleRecord = 'Recording: On/Off'
    Action_ObsToggleRecordPause = 'Recording pause: On/Off'
    Action_ObsStartRecord = 'Start recording'
    Action_ObsStopRecord = 'Stop recording'
    Action_ObsStartReplayBuffer = 'Start replay buffer'
    Action_ObsStopReplayBuffer = 'Stop replay buffer'
    Action_ObsSaveReplay = 'Save replay buffer'
    Action_ObsToggleVirtualCamera = 'Virtual camera: On/Off'
    Action_ObsToggleStudioMode = 'Studio mode: On/Off'
    Action_ObsStudioTransition = 'Trigger studio mode transition'
    Action_ObsToggleMedia = 'Media: play/pause'
    Action_ObsStopMedia = 'Stop media source'
    ...
    Automation_ActionPickerTitle = 'Add action to automation'
    Automation_AddStep = 'Add step'
    Automation_AddAction = 'Action'
    Automation_Pause = 'Pause'
    Automation_PauseHint = 'Wait before the next step'
    Automation_Finish = 'Finish'
    Automation_FinishHint = 'Skip all remaining steps and finish the automation'
    Automation_Seconds = 'seconds'
    Automation_MoveUp = 'Move up'
    Automation_MoveDown = 'Move down'
    Automation_MacroSteps = 'Macro steps: {0}'
    Automation_VolumeStep = 'Step: {0}%'
    Automation_InvalidPause = 'Enter a pause between 0.1 and 3600 seconds.'
    Automation_Empty = 'Add at least one element to the automation.'
    Automation_TooManySteps = 'An automation cannot contain more than {0} steps.'
    ...
    Error_OpenReleasesLink = 'Could not open the releases page'
...
$russianStrings = [ordered]@{
    ...
    Capture_NumPad = 'NumPad'
    Capture_NavigationBlock = '6 клавиш'
    Capture_NumPadHint = 'Перехватывать клавиши NumPad'
    Capture_NavigationBlockHint = 'Перехватывать клавиши Insert, Home, Page Up, Delete, End и Page Down'
    ...
    'Settings_UpdatesTitle.Text' = 'Следите за обновлениями'
    'Settings_UpdatesHint.Text' = 'Следите за StreamNumDeck на GitHub, чтобы не пропустить новые версии, исправления и возможности.'
    'Settings_ReleasesButton.Content' = 'Последний релиз'
    ...
    ActionGroup_Automation = 'Автоматизация'
    ...
    Action_ObsToggleStream = 'Трансляция: Вкл/Выкл'
    Action_ObsStartStream = 'Начать трансляцию'
    Action_ObsStopStream = 'Остановить трансляцию'
    Action_ObsToggleRecord = 'Запись: Вкл/Выкл'
    Action_ObsToggleRecordPause = 'Пауза записи: Вкл/Выкл'
    Action_ObsStartRecord = 'Начать запись'
    Action_ObsStopRecord = 'Остановить запись'
    Action_ObsStartReplayBuffer = 'Запустить буфер повтора'
    Action_ObsStopReplayBuffer = 'Остановить буфер повтора'
    Action_ObsSaveReplay = 'Сохранить повтор'
    Action_ObsToggleVirtualCamera = 'Виртуальная камера: Вкл/Выкл'
    Action_ObsToggleStudioMode = 'Студийный режим: Вкл/Выкл'
    Action_ObsStudioTransition = 'Выполнить переход студийного режима'
    Action_ObsToggleMedia = 'Медиа: пуск/пауза'
    Action_ObsStopMedia = 'Остановить медиаисточник'
    ...
    Action_Automation = 'Автоматизация'
    Automation_ActionPickerTitle = 'Добавить действие в автоматизацию'
    Automation_AddStep = 'Добавить элемент'
    Automation_AddAction = 'Действие'
    Automation_Pause = 'Пауза'
    Automation_PauseHint = 'Подождать перед следующим элементом'
    Automation_Finish = 'Завершить'
    Automation_FinishHint = 'Пропустить оставшиеся элементы и завершить автоматизацию'
    Automation_Seconds = 'секунд'
    Automation_MoveUp = 'Переместить выше'
    Automation_MoveDown = 'Переместить ниже'
    Automation_MacroSteps = 'Шагов макроса: {0}'
    Automation_VolumeStep = 'Шаг: {0}%'
    Automation_InvalidPause = 'Укажите паузу от 0,1 до 3600 секунд.'
    Automation_Empty = 'Добавьте в автоматизацию хотя бы один элемент.'
    Automation_TooManySteps = 'Автоматизация не может содержать больше {0} элементов.'
    ...
    Error_OpenReleasesLink = 'Не удалось открыть страницу релизов'
...
$catalogPath = Join-Path $root 'src\StreamNumDeck.Wpf\Presentation\BuiltInIconCatalog.cs'
